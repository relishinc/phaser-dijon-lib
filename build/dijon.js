    ...
    return {
        ...
        execute: function() {
            LabelledButton = (function (_super) {
                ...
                LabelledButton.prototype.addLabel = function (text, fontSize, fontName, outTint, downTint, overTint, upTint) {
                    if (outTint === void 0) { outTint = 0xffffff; }
                    if (fontSize < 1) {
                        fontSize = fontSize * this.realHeight;
                    }
                    this._label = new display_1.Text(this.realWidth * 0.5, this.realHeight * 0.5 + 8, text, fontName, fontSize, "#ffffff");
