...
Popup.prototype.startAutoRemoveTimer = function(){
    this.removalTween = this.game.add.tween(this).to({alpha:0}, 200, Phaser.Easing.Linear.Out, true, this.autoRemoveTime * Phaser.Timer.SECOND).onComplete.addOnce(this.removeThis, this);
};
